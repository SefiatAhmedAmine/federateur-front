                ...
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <img src="https://i.imgur.com/xhzhaGA.jpg" class="img-fluid" alt="img" />
                            <div class="p-2">
                                description :
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex flex-row muted-color"> <span>Available : {response.available}</span> <span class="ml-2"></span> </div>
                                </div>
                                <hr />
                                <div class="comments">
                                    votre réponse :
                                    <div class="d-flex flex-row mb-2">
                                        <div class="d-flex flex-column ml-2"> <small class="comment-text">{response.responds[0].message}</small>
                                            <div class="d-flex flex-row align-items-center status"> <small>Verifié : {response.responds[0].verified}</small><small></small> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
